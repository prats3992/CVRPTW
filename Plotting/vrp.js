function initMap() {
  const mapData = [
    // { start: "Plaksha University, Mohali", waypoints: ["Chandigarh Airport"], end: "Chandigarh Airport" },
    // { start: "Amity University, Punjab", waypoints: ["Plaksha University, Mohali"], end: "Plaksha University, Mohali" },
    // { start: "Plaksha University, Mohali", waypoints: [], end: "Chandigarh Airport" },
// { start: "Amity University, Punjab", waypoints: [], end: "Plaksha University, Mohali" },
    {
