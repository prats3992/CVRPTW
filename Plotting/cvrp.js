function initMap() {
  ...
  const mapData = [
{start: 'Dtdc Courier Service Aerocity mohali', end: 'Dtdc Courier Service Aerocity mohali', waypoints: ['Sharon Resort']},
{start: 'Dtdc Courier Service Aerocity mohali', end: 'Dtdc Courier Service Aerocity mohali', waypoints: ['Jayant education', 'Akm Resorts']},
{start: 'Dtdc Courier Service Aerocity mohali', end: 'Dtdc Courier Service Aerocity mohali', waypoints: ['Radisson Hotel Chandigarh Zirakpur']},
{start: 'Dtdc Courier Service Aerocity mohali', end: 'Dtdc Courier Service Aerocity mohali', waypoints: ['Bestech Square Mall', 'The Mohali Club || Wyndham Chandigarh Mohali']},
{start: 'Dtdc Courier Service Aerocity mohali', end: 'Dtdc Courier Service Aerocity mohali', waypoints: ['Strawberry Global Smart School', 'The Amaltas Farms']},
{start: 'Dtdc Courier Service Aerocity mohali', end: 'Dtdc Courier Service Aerocity mohali', waypoints: ['Plaksha University', 'Singh Sheeda Gurdwara Sahib']},
{start: 'Dtdc Courier Service Aerocity mohali', end: 'Dtdc Courier Service Aerocity mohali', waypoints: ['Amity University, Mohali']},
{start: 'Dtdc Courier Service Aerocity mohali', end: 'Dtdc Courier Service Aerocity mohali', waypoints: ['Mahendra Chaudhary Zoological Park, Chhat Bir Zoo, Zirakpur', 'La Palacio Luxury Banquet & Lawns', 'Wedding Palace in Zirakpur']},
{start: 'Dtdc Courier Service Aerocity mohali', end: 'Dtdc Courier Service Aerocity mohali', waypoints: ['Mohali IT City Park']},
{start: 'Dtdc Courier Service Aerocity mohali', end: 'Dtdc Courier Service Aerocity mohali', waypoints: ['Gurdwara Dushat Daman Durali', 'JLPL Falcon View']},
  ];
